                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-size-20">
                            <a href="{{ route('admin.galleries-items.index', ['gallery_id' => $gallery->id]) }}" class="btn btn-sm btn-info" title="Slides">
                                <i class="fas fa-images"></i>
                            </a>

                            <a href="{{ route('admin.galleries.edit', [$gallery]) }}" class="btn btn-sm btn-success" title="Edit this">
